...
const UpdateCompanyInfoModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append('company_name', e.target.company_name.value);
      ...
      const response = await axios.post('http://endpointshop/api.php?action=updateCompany', formDataToSend);
      ...
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input type="text" id="company_name" name="company_name" defaultValue={user.company_name} />
          </div>
          <div>
            <label htmlFor="description">Company Description:</label>
            <input type="text" id="description" name="description" defaultValue={user.description} />
          </div>
          <div>
